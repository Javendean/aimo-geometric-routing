...
**Tension 3:** The competition allows two attempts per problem. Should we use this for routing diversity (attempt 1: topic-routed, attempt 2: generic) or answer hedging (attempt 1: majority, attempt 2: second-most-common)?
...
How should this model's reasoning be organized across 110 diverse math problems to maximize total solve rate?
